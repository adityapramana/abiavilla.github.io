...
if ( isset( HotelCaliforniaTheme::$boldthemes_options['pf_settings_page_slug'] ) && HotelCaliforniaTheme::$boldthemes_options['pf_settings_page_slug'] != '' ) {
	HotelCaliforniaTheme::$boldthemes_page_for_header_id = boldthemes_get_id_by_slug( HotelCaliforniaTheme::$boldthemes_options['pf_settings_page_slug'] );
}
...
if ( have_posts() ) {
	...
	if ( $categories_html != '' ) {
		$meta_right_html .= '<dt>' . esc_html__( 'Category', 'hotelcalifornia' ) . '</dt>';
					...
					<div class="boldRow ">
						<div class="rowItem col-sm-12 col-md-12 btTextLeft inherit btMiddleVertical">
							<div class="rowItemContent">
								...
								<span class="btGetInfo"><?php echo boldthemes_get_icon_html( 'fa_f129', '#', '', 'default colorless extrasmall' ); ?></span>
								<div class="btInfoBar">
									<div class="btInfoBarMeta">
										<p><strong></strong> <?php echo get_the_title(); ?></p>
										<p><strong><?php esc_html_e( 'Title:', 'hotelcalifornia' ); ?></strong> <span class="btPortfolioSliderCaption"></span></p>
										<p><strong><?php esc_html_e( 'Description:', 'hotelcalifornia' ); ?></strong> <span class="btPortfolioSliderDescription"></span></p>
									</div><!-- /boldInfoBarMeta -->
								</div><!-- /boldInfoBar -->
							</div><!-- /rowItemContent -->
						</div><!-- /rowItem -->
	...
	$content_html = str_replace( ']]>', ']]&gt;', $content_html );
		...
		if ( '' != $prev ) {
			...
			$prev_next_html .= '<span class="nbsItem"><span class="nbsDir">' . esc_html__( 'previous', 'hotelcalifornia' ) . '</span><span class="nbsTitle">' . esc_html( $prev->post_title ) . '</span></span>';
			$prev_next_html .= '</a></h4>';
		}
		$prev_next_html .= '</div>';
		...
		if ( '' != $next ) {
			...
			$url = $thumb[0];
			$prev_next_html .= '<span class="nbsItem"><span class="nbsDir">' . esc_html__( 'next', 'hotelcalifornia' ) . '</span><span class="nbsTitle">' . esc_html( $next->post_title ) . '</span></span>';
			// if ($url != '') $prev_next_html .= '<span class="nbsImage"><span class="nbsImgHolder" style="background-image:url(\'' . $url . '\');"></span></span>';
			$prev_next_html .= '</a></h4>';
