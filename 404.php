					...
					<div class="boldRow ">
						<div class="rowItem col-ms-12 btTextCenter">
							<div class="rowItemContent">
								<?php echo boldthemes_get_heading_html( esc_html__( 'We are sorry, page not found.', 'hotelcalifornia' ), esc_html__( 'Error 404.', 'hotelcalifornia' ), "<a href='" . site_url() . "'>" . esc_html__( 'Back to homepage', 'hotelcalifornia' )."</a>", 'extralarge', 'bottom', '', '' ) ?>
							</div>
						</div>
					</div>
				</div>
