		...
		echo '<div class="port">';
			echo '<div class="boldCell">';
				echo '<div class = "boldRow">';
					echo '<div class="rowItem col-sm-12 btTextLeft">';
							...
							if ( $blog_side_info ) {
								...
								echo '<div class="btArticleListBody' . $extra_class . '">';				
									...
									echo '<div class="boldRow btArticleFooter">';
										echo '<div class="rowItem col-sm-6 col-ms-12 btTextLeft btReadArticle"><a class="btContinueReading" href="' . esc_attr( $permalink ) . '">' . esc_html__( 'CONTINUE READING', 'hotelcalifornia' ) . '</a></div>';
