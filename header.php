...
<div class="btPageWrap" id="top">
        ...
        <div class="port">
			...
			<div class="btLogoArea menuHolder btClear">
				<?php if ( has_nav_menu( 'primary' ) ) { ?>
					<span class="btVerticalMenuTrigger"><?php echo boldthemes_get_icon_html( 's7_e636', '#', '', 'btIcoMediumSize btIcoDefaultColor btIcoDefaultType' ); ?></span>
					<span class="btHorizontalMenuTrigger"><?php echo boldthemes_get_icon_html( 's7_e636', '#', '', 'btIcoMediumSize btIcoDefaultColor btIcoDefaultType' ); ?></span>
				<?php } ?>
				<div class="logo">
					<span>
	...
	<div class="btContentWrap btClear">
		<?php if ( HotelCaliforniaTheme::$boldthemes_page_for_header_id != '' && ! is_search() ) { ?>
			<?php
				$content = get_post( HotelCaliforniaTheme::$boldthemes_page_for_header_id );
